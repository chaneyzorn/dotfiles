...
(function()
    ...
    vim.g.Illuminate_ftblacklist = {
        "nerdtree", "qf", "leaderf", "help", "list", "vista", "man"
    }
...
(function()
    ...
    vim.g.rainbow_conf = {
        guifgs = {
            "tan", "PaleGreen", "SkyBlue", "gold", "orchid", "orange",
            "Fuchsia", "ivory"
        },
...
(function() vim.g.SuperTabDefaultCompletionType = "<c-n>" end)(
    "ervandew/supertab");
...
(function() end)("voldikss/vim-floaterm");
...
(function()
    ...
    vim.g.UltiSnipsSnippetsDir = vim.fn.stdpath("config") ..
                                     "/moetools/UltiSnips"
end)("SirVer/ultisnips");

(function() end)("kkoomen/vim-doge");
...
(function()
    ...
    vim.g.Lf_WildIgnore = {
        dir = {
            ".svn", ".git", ".hg", "build", "debug", ".idea", ".ropeproject",
            "vendor"
        },
...
(function() vim.g.go_def_reuse_buffer = 1 end)("fatih/vim-go");
...
(function()
    vim.g.coc_global_extensions = {
        "coc-tsserver", "coc-eslint", "coc-prettier", "coc-css", "coc-json",
        "coc-vimlsp", "coc-yaml", "coc-snippets", "coc-python", "coc-lists",
        "coc-marketplace", "coc-pairs", "coc-dictionary", "coc-word",
        "coc-emoji", "coc-syntax", "coc-go", "coc-rust-analyzer", "coc-explorer"
    }
